...
namespace Core.Initialization.INi
{
	...
	{
		public List<IniFileSection> sections = new List<IniFileSection>();
		public List<IniFileElement> elements = new List<IniFileElement>();
			...
			if (ret.elements.Count > 0) {
				...
				for (int i = 0; i < ret.elements.Count; i++) {
					...
					if (el is IniFileSectionStart) {
                        ...
                        //Exists needs to be changed to work on XBOX 360 CLR
	...
	{
		public List<IniFileElement> elements = new List<IniFileElement>();
        public IniFileSectionStart sectionStart;
