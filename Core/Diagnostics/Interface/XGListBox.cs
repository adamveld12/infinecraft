...
namespace Core.Diagnostics.Interface
{
    ...
    public class XGListBox : XGControl
    {
        ...
        public override void Draw(float frameTime)
        {
            ...
            */
            ...
            XnaGUIManager.spriteBatch.GraphicsDevice.RasterizerState = new RasterizerState() { ScissorTestEnable = true };//RenderState.ScissorTestEnable = true;
            ...
            XnaGUIManager.spriteBatch.GraphicsDevice.RasterizerState = new RasterizerState() { ScissorTestEnable = false };//RenderState.ScissorTestEnable = false;
            XnaGUIManager.spriteBatch.Begin();
