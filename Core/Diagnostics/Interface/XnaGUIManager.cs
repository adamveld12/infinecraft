...
namespace Core.Diagnostics.Interface
{
    public static class XnaGUIManager
    {
        ...
        public static void Initialize(EngineContext game)
        {
            Game = game;
            spriteBatch = new SpriteBatch(game.GraphicsDevice);
            spriteFont = game.EngineContent.Load<SpriteFont>("GuiSpriteFont");
            whiteTex = game.EngineContent.Load<Texture2D>("WhiteRect");
            Active = false;
        }
